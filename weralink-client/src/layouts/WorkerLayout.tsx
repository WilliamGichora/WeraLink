...
import { Link as LinkIcon, Bell, LogOut } from "lucide-react";
    ...
    <div className="bg-background-light dark:bg-background-dark font-display text-text-main font-sans antialiased min-h-screen flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="#" className="text-gray-500 hover:text-accent-text font-medium px-1 py-5 transition-colors dark:text-gray-400">My Gigs</a>
              <a href="#" className="text-gray-500 hover:text-accent-text font-medium px-1 py-5 transition-colors dark:text-gray-400">Wallet</a>
              <a href="#" className="text-gray-500 hover:text-accent-text font-medium px-1 py-5 transition-colors dark:text-gray-400">Profile</a>
            </div>
      ...
      <footer className="bg-white border-t border-gray-200 py-8 dark:bg-black dark:border-gray-800 mt-auto relative z-50">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="text-gray-500 text-sm">&copy; {new Date().getFullYear()} WeraLink. Empowering Kenyan Youth.</p>
        </div>
      </footer>
    </div>
  );
