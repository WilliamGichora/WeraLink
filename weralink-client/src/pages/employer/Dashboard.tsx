                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col lg:flex-row gap-8">
                                    ...
                                    <div className="p-6 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                            <div className="flex items-start gap-4">
                                                <div className="h-12 w-12 rounded-lg bg-gray-300 dark:bg-gray-700 overflow-hidden shrink-0"></div>
                                                <div>
                        ...
                        <aside className="w-full lg:w-1/4 flex flex-col gap-6">
                            <Link to="/employer/gigs/new" className="w-full bg-primary-wera hover:bg-primary-dark text-white p-4 rounded-xl font-bold shadow-lg transition-all transform hover:-translate-y-1 flex items-center justify-center gap-2 text-lg">
